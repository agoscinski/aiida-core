...
###########################################################################
"""Tests for the :mod:`aiida._core.orm.nodes.data.array.bands` module."""
...
class TestGetBandsAndParentsStructure:
    """Tests for the :meth:`~aiida._core.orm.nodes.data.array.bands.get_bands_and_parents_structure` function."""
