...
###########################################################################
"""Tests for the :mod:`aiida._core.common.folders` module."""
...
def test_create_file_from_filelike(tmpdir):
    """Test the :meth:`aiida._core.common.folders.Folder.create_file_from_filelike` method."""
...
def test_open(tmpdir):
    """Test the :meth:`aiida._core.common.folders.Folder.open` method."""
    filename = 'random.dat'
    folder = Folder(tmpdir)
...
def test_sandbox():
    """Test the :class:`aiida._core.common.folders.SandboxFolder` class."""
...
def test_sandbox_filepath(tmp_path):
    """Test the :class:`aiida._core.common.folders.SandboxFolder` class with the ``filepath`` argument."""
