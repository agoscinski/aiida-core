...
###########################################################################
"""Tests for the :mod:`~aiida._core.common.timezone` module."""
...
from aiida._core.common.timezone import delta, localtime, make_aware, now, timezone_from_name
...
def test_now():
    """Test the :func:`aiida._core.common.timezone.now` function.
...
def test_make_aware_already_aware():
    """Test the :func:`aiida._core.common.timezone.make_aware` function for an already aware datetime.
...
def test_localtime_aware():
    """Test the :func:`aiida._core.common.timezone.test_localtime` function for an already aware datetime.
...
def test_localtime_naive():
    """Test the :func:`aiida._core.common.timezone.test_localtime` function for a naive datetime.
...
def test_make_aware_timezone():
    """Test the :func:`aiida._core.common.timezone.make_aware` function passing an explicit timezone."""
...
def test_timezone_from_name():
    """Test the :func:`aiida._core.common.timezone.timezone_from_name` function."""
    assert isinstance(timezone_from_name('Europe/Amsterdam'), tzinfo)


def test_timezone_from_name_unknown():
    """Test the :func:`aiida._core.common.timezone.timezone_from_name` function for unknown timezone."""
    with pytest.raises(ValueError, match=r'unknown timezone: .*'):
        timezone_from_name('Invalid/Unknown')


def test_delta():
    """Test the :func:`aiida._core.common.timezone.delta` function."""
