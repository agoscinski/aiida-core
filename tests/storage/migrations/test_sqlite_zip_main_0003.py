...
def test_downgrade_not_supported():
    """Downgrading out of ``main_0003`` is explicitly not supported."""
    from aiida.storage.sqlite_zip.migrations.versions.main_0003 import downgrade
