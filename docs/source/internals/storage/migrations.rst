...
For example, ``main_0003_add_dbsetting.py`` contains ``revision = 'main_0003'`` and ``down_revision = 'main_0002'``.
...
The ``sqlite_dos`` migration schema tests name their regression snapshots as ``test_<revision_id>.yml``.
