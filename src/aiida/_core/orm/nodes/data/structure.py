...
class StructureData(Data):
    ...
    def get_ase(self):
        ...
        :return: an ASE object corresponding to this
          :py:class:`StructureData <aiida._core.orm.nodes.data.structure.StructureData>`
          object.
    ...
    def append_atom(self, **kwargs):
        ...
        .. note :: checks of equality of species are done using
          the :py:meth:`~aiida._core.orm.nodes.data.structure.Kind.compare_with` method.
        """
    ...
    def get_cif(self, converter='ase', store=False, **kwargs):
        ...
        :return: :py:class:`aiida._core.orm.nodes.data.cif.CifData` node.
        """
