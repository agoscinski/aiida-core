...
class XyData(ArrayData):
    ...
    .. note:: The :meth:`~aiida._core.orm.nodes.data.array.array.ArrayData.get_arraynames` method
        inherited from :class:`~aiida._core.orm.nodes.data.array.array.ArrayData` returns the internal
