...
if t.TYPE_CHECKING:
    ...
    from aiida._core.orm.nodes.data.structure import Kind, StructureData
...
class TrajectoryData(ArrayData):
    ...
    def set_structurelist(self, structurelist: list[StructureData]) -> None:
        ...
        :py:class:`aiida._core.orm.nodes.data.structure.StructureData` instances.
    ...
    def get_step_structure(self, index: int, custom_kinds: list[Kind] | None = None) -> StructureData:
        """Return an AiiDA :py:class:`aiida._core.orm.nodes.data.structure.StructureData` node
        ...
        :param custom_kinds: (Optional) If passed must be a list of
          :py:class:`aiida._core.orm.nodes.data.structure.Kind` objects. There must be one
          ...
          :py:class:`aiida._core.orm.nodes.data.structure.StructureData` nodes is used,
          meaning that the strings in the ``symbols`` array must be valid
          chemical symbols.

        :return: :py:class:`aiida._core.orm.nodes.data.structure.StructureData` node.
        """
    ...
    def get_structure(self, store: bool = False, **kwargs: t.Any) -> StructureData:
        """Creates :py:class:`aiida._core.orm.nodes.data.structure.StructureData`.
        ...
        :param custom_cell: (Optional) The cell matrix of the structure.
          ...
          :py:class:`aiida._core.orm.nodes.data.structure.StructureData` will be used.

        :return: :py:class:`aiida._core.orm.nodes.data.structure.StructureData` node.
        """
        from aiida._core.orm.nodes.data.dict import Dict
    ...
    def get_cif(self, index: int | None = None, **kwargs: t.Any) -> t.Any:
        """Creates :py:class:`aiida._core.orm.nodes.data.cif.CifData`"""
    ...
    def _parse_xyz_pos(self, inputstring: str) -> None:
        ...
        Usage::
            ...
            from aiida._core.orm.nodes.data.array.trajectory import TrajectoryData
