...
class BandsData(KpointsData):
    ...
    def _prepare_mpl_singlefile(self, *args, **kwargs):
        ...
        :py:meth:`~aiida._core.orm.nodes.data.array.bands.BandsData._matplotlib_get_dict`
        """
...
def _extract_formula(akinds, asites, args):
    ...
    """
    from aiida._core.orm.nodes.data.structure import get_formula, get_symbols_string
