...
FilterType = dict[str, Any] | fields.QbFieldFilters | fields.QbField
...
class QueryBuilder:
    ...
    def _process_filters(filters: FilterType) -> dict[str, Any]:
        """Process filters."""
        if isinstance(filters, fields.QbField):
            # A boolean field stands for `field == True`; any other type has no such reading.
