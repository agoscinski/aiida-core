...
def resolve_deprecated_option_name(option_name: str, stacklevel: int = 4) -> str:
    ...
    :class:`aiida._core.common.warnings.AiidaDeprecationWarning` is emitted through
    :func:`aiida._core.common.warnings.warn_deprecation` and the name of the replacement option is
    ...
    :param stacklevel: stacklevel forwarded to :func:`aiida._core.common.warnings.warn_deprecation`.
